...
Accompanying materials for manuscript "Is Reality Still Socially Constructed?", published 2026 in *The American Sociologist* (https://doi.org/10.1007/s12108-026-09681-x). Licensing agreements from Constellate and JSTOR prevent sharing complete full-text data, but analysis scripts and secondary datasets are included here as available. 
